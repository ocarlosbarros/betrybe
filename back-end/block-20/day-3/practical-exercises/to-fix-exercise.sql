...
-- 2.Precisamos de um relatório dos nomes dos clientes, em ordem alfabética , que não estão mais ativos no nosso sistema
...
SELECT first_name FROM customer
	WHERE active IS NOT TRUE AND first_name <> 'KENNETH'
    ORDER BY first_name;
...
-- do valor mais alto ao mais baixo, entre os filmes feitos para menores de idade
...
-- Em caso de empate, ordene em ordem alfabética pelo título. As informações podem ser encontradas na tabela film
    ...
    FROM film
		WHERE rating = 'NC-17'
		ORDER BY rental_rate, title ASC LIMIT 50;