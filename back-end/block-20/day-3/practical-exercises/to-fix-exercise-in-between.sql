...
-- 2.	Mostre o e-mail dos clientes com os address_id 172, 173, 174, 175 e 176 , ordenados em ordem alfabética.
	...
	SELECT email 
		FROM sakila.customer
        WHERE address_id BETWEEN 172 AND 176 ORDER BY email;-- Query cost 2.51 with BETWEEN and 3.51 with IN
...
-- 	Os resultados devem ser classificados em filmes com maior duração de empréstimo primeiro. Em caso de empate, ordene em ordem alfabética pelo título.
    ...
    ORDER BY rental_duration DESC, title; -- Query Cost de 214.10 with BETWEEN and 503 with IN
