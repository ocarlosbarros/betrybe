...
-- 	cujo o código inicie com a letra A . Ordene o resultado em ordem alfabética.
...
-- 	que possuam em seu código o número 3 . Ordene o resultado em ordem alfabética.
...
-- 	de todos os projetos cujas horas sejam maiores que 250 e menores 800.
		...
		SELECT *
			FROM Scientists.Projects
            WHERE Hours > 250 AND Hours < 500;

-- 7.	Escreva uma query para exibir o nome e o código de todos
-- 	os projetos cujo nome NÃO inicie com a letra A .
